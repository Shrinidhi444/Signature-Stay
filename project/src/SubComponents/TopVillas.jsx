...
const TopVillas = () => {
  return (
    <section id="topVillas">
      <h1>SIGNATURE LUXURY VILLAS</h1>
      <p>
        Discover our handpicked collection of premium villas crafted for
        comfort, privacy, and elegance. Each stay promises world-class
        amenities, prime locations, and an unforgettable living experience.
      </p>
